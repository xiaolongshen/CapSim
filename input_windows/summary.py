...
class Summary:
    ...
    def make_batch_file(self, Filepath):
        ...
        for chemical in self.system.chemicals:
            file.write("    systems[i].BCs['"+chemical.name+"'] = BC('"+chemical.name+"', 1)\n")
            if self.system.topBCtype == 'Fixed Concentration':
        ...
        if self.system.topBCtype == 'Finite mixed water column':
            ...
            file.write("    systems[i].taucoefs['Decay'] = '"+self.system.taucoefs["Decay"]+"'\n")
            file.write("    systems[i].taucoefs['Evap'] = '" +self.system.taucoefs["Evap"]+"'\n")
        file.write("\n\n")
