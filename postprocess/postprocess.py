            ...
            if self.top.window.cancelflag == 0:
                ...
                if self.type == self.types[0]:
                    ...
                    for n in range(len(self.timeplotdatas)):
                        ...
                        if self.variable == 'Material fraction':
                            self.timeplotdatas[n].legend = self.timeplotdatas[n].component + ' ' +  str(self.timeplotdatas[n].value) + ' ' + self.timeunit
                        else:
                            self.timeplotdatas[n].legend = self.timeplotdatas[n].name + ' ' +  str(self.timeplotdatas[n].value) + ' ' + self.timeunit
